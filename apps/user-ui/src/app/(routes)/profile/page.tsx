...
import { capitalize } from 'apps/user-ui/src/utils/capitalize';
import {
  Bell,
  CheckCircle,
  Clock,
      ...
      <div className="md:max-w-7xl mx-auto">
          ...
          <h1 className="text-3xl font-bold text-gray-800">
            ...
            <span className="text-blue-600">
              {isLoading ? (
                ...
                `${capitalize(user?.name?.split(' ')[0]) || 'User'}`
              )}
            </span>{' '}
            👋
          </h1>
        ...
        <div className="mt-10 flex flex-col md:flex-row gap-6">
          ...
          <div className="bg-white p-6 rounded-md shadow-sm border border-gray-100 w-full md:w-[55%]">
            <h2 className="text-xl font-semibold t3ext-gray-800 mb-4">
              {activeTab}
            </h2>
              ...
              <div className="space-y-4 text-sm text-gray-700">
                <div className="flex items-center gap-3">
                  <Image
                    src={
                      user?.avatar ||
                      'https://ik.imagekit.io/5frbx53sr/avatar/user-avatar.svg'
                    }
                    alt="profile image"
                    width={60}
                    height={60}
