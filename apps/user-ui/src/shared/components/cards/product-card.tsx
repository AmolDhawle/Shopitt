...
const ProductCard = ({
  ...
  const isInCart = cart.some((items: any) => items.id === product.id);
  ...
  return (
    <div className="w-full min-h-[350px] h-max bg-white rounded-lg relative">
      ...
      <Link href={`/product/${product?.slug}`}>
        <img
          src={
            ...
            'https://unsplash.com/photos/black-iphone-7-plus-on-white-surface-ZwKCWVFdrcs'
          }
          alt={product?.title}
          width={300}
          height={300}
      ...
      <div className="mt-3 flex justify-between items-baseline px-2">
      ...
      <div className="absolute z-[10] flex flex-col gap-3 right-3 top-8">
