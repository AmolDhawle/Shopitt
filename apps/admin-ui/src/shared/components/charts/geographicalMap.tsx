...
const countryData = [
  { name: 'India', users: 100, sellers: 35 },
  { name: 'United States of America', users: 100, sellers: 20 },
  { name: 'United Kingdom', users: 70, sellers: 15 },
  { name: 'Germany', users: 50, sellers: 10 },
  { name: 'Canada', users: 40, sellers: 5 },
];
      ...
      <AnimatePresence>
        {hovered && (
          ...
          >
            ...
            <br />
            Users: <span className="teext-green-400">{hovered.users}</span>
            <br />
