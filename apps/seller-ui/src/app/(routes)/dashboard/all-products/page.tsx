...
import DeleteConfirmationModal from 'apps/seller-ui/src/shared/modals/delete-confirmation-modal';
    ...
    <div className="w-full min-h-screen p-8">
      ...
      <div className="flex justify-between items-center mb-1">
        ...
        <Link
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex justify-between items-center gap-2"
        >
      ...
      {/* Search Bar */}
      <div className="flex items-center bg-gray-900 p-2 mb-4 rounded-md flex-1">
