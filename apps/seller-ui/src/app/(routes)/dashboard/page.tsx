...
import GeographicalMap from '@seller-ui/shared/components/charts/geographicalMap';
import SalesChart from '@seller-ui/shared/components/charts/salesChart';
import { Legend, Pie, ResponsiveContainer, Tooltip, PieChart } from 'recharts';

const deviceData = [
  { name: 'Phone', value: 55, fill: '#4ade80' },
  { name: 'Tablet', value: 20, fill: '#facc15' },
...
// orders data
const orders = [
  { id: 'ORD-001', customer: 'Rahul Jagtap', amount: '₹2500', status: 'PAID' },
  {
    id: 'ORD-002',
  ...
  { id: 'ORD-003', customer: 'Avni Sharma', amount: '₹9999', status: 'FAILED' },
  { id: 'ORD-004', customer: 'Vinod Mishra', amount: '₹12999', status: 'PAID' },
  {
    id: 'ORD-005',
    customer: 'Aditi Hedge',
    amount: '₹117999',
    status: 'PENDING',
  },
];
      ...
      <div className="w-full flex gap-8">
        ...
        <div className="w-[35%] rounded-2xl shadow-xl">
          <h2 className="text-white text-xl font-semibold mb-2">
            Device Usage
            <span className="block text-sm text-slate-400 font-normal">
              How visitors access your platform
            </span>
          </h2>
